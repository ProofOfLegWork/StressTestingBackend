@echo off
echo Running API TESTING MEGA load test with 5000 virtual users for 1 minute...
...
docker cp k6-runner:/scripts/api-testing-report.html ./reports/api-testing-report.html
echo Copied standard report to ./reports/api-testing-report.html

REM Try to get any timestamped reports
echo Looking for timestamped reports...
docker exec k6-runner ls /scripts/api-testing-report-*.html 2>nul
if %ERRORLEVEL% EQU 0 (
