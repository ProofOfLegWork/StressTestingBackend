@echo off
echo Running API TESTING load test locally for wallet operations with a reduced number of virtual users for 1 minute...
...
REM No need to modify API paths as they're already correctly set in the script
...
echo Test completed!
echo HTML report has been saved to api-testing-wallet-report.html
echo.
